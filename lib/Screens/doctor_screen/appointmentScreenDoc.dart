...
class _DoctorAppointmentsScreenState extends State<DoctorAppointmentsScreen> {
  ...
  void initState() {
    ...
    _appointmentController.fetchAppointments(true);
  }
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ScheduleItem(
                    status: status == FilterStatus.cancel
                        ? 3
                    ...
                    isDoctor: status == FilterStatus.complete ||
  ...
  Widget _buildStatusButton(
      String title, int index, FilterStatus filterStatus) {
    return Expanded(
      child: InkWell(
        onTap: () {
          setState(() {
